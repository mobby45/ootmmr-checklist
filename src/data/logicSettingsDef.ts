...
export const LOGIC_SETTINGS_DEFS: LogicSettingDef[] = [
  ...
  { group: 'Special', key: 'openZdShortcut',      label: "Zora's Domain Shortcut",      type: 'bool',       default: false,
    desc: "The underwater shortcut in Zora's Domain is open from the start." },
  { group: 'Special', key: 'ootPreplantedBeans',  label: 'Pre-planted Beans (OoT)',     type: 'bool',       default: false,
    desc: 'Magic Bean spots in OoT are already planted at the start — Beanstalk access without using beans.' },
  { group: 'Special', key: 'shuffleMasterSword',  label: 'Shuffle Master Sword',        type: 'bool',       default: false,
    desc: 'The Master Sword is shuffled into the item pool instead of being at the Pedestal of Time.' },
  { group: 'Special', key: 'kegStrength3',        label: 'Keg Strength (3rd Upgrade)', type: 'bool',       default: false,
